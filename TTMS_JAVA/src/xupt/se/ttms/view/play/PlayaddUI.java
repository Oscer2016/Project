...
public class PlayaddUI extends JFrame implements ActionListener, MouseListener {
	...
	JComboBox lang_comboBox, type_comboBox;
	...
	public PlayaddUI(PlayUI jframe) {
...
//		contentPane.add(label5);
		...
		textArea.setBounds(90, 265, 220, 160);
		contentPane.add(textArea);
		JLabel label6 = new JLabel("剧目简介");
		label6.setFont(MyFont.Item);
		label6.setBounds(20, 265, 80, 30);
