...
import xupt.se.ttms.view.admin.*;
...
public class MainUITmpl extends JPanel  {
	...
	protected final ImagePanel headPan = new ImagePanel(new ImageIcon(
			"resource/image/welcome.jpg").getImage());
...
//		UserModifyUI dlgUserMod = new UserModifyUI(null);
