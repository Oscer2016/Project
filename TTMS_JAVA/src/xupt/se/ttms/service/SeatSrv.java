...
public class SeatSrv {
	...
	public int modify(int studio_id, int row, int col) {
		return seatDAO.update(studio_id, row, col);
	}
	
	public int lockSeat(int seat_id, String date) {
		return seatDAO.lockSeat(seat_id, date);
	}
	
	public int unlockSeat(int ID) {
		return seatDAO.unlockSeat(ID);
	}
